        ...
        <div class="card edit-detail">
          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field-label-items">
                <label class="checkbox" for="active">active</label>
                <input type="checkbox" class="is-primary" id="active" v-model="hero.active"/>
              </div>
            </div>
          </div>
          <footer class="card-footer">
            <button class="btn link card-footer-item cancel-button" @click="cancelHero">
              <i class="fas fa-undo"></i>
              <span>Cancel</span>
            </button>
            <button class="link card-footer-item btn" @click="saveHero">
